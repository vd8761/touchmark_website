...
export default function Page({ searchParams }: PageProps) {
  ...
  return (
    ...
    <link rel="Touchmark" href="e-book-01.php%3Febook_content_id=1.html#" />
...
<div id="modelConfirm" className="fixed hidden z-50 inset-0 bg-black/70 overflow-y-auto h-full w-full px-4">
    <div className="flex justify-center items-center h-full">
        <div className="relative mx-auto shadow-xl bg-white max-w-[500px]">
            ...
            <div className="flex items-end justify-between p-2">
                <a href="e-book-01.php%3Febook_content_id=1.html#" id="goBack" className="flex justify-start items-center text-[#194F97] hover:underline text-sm hidden">
    ...
    <link rel="Touchmark" href="e-book-01.php%3Febook_content_id=1.html#" />
          ...
          {/* Ebook 1 Scripts */}
          <Script id="ebook-script-1-0" strategy="lazyOnload">{`
        try {
      ...
      `}</Script>
<Script id="ebook-script-1-1" strategy="lazyOnload">{`
        try {
    ...
    document.getElementById('goBack').addEventListener('click', function(event) {
      ...
      `}</Script>
<Script id="ebook-script-1-2" strategy="lazyOnload">{`
        try {
          document.addEventListener("DOMContentLoaded", function() {
      ...
      `}</Script>
<Script id="ebook-script-1-3" strategy="lazyOnload">{`
        try {
      ...
      `}</Script>
<Script id="ebook-script-1-4" strategy="lazyOnload">{`
        try {
      ...
      `}</Script>
<Script id="ebook-script-1-5" strategy="lazyOnload">{`
        try {
      ...
      `}</Script>
<Script id="ebook-script-1-6" strategy="lazyOnload">{`
        try {
      ...
      `}</Script>
<Script id="ebook-script-1-7" strategy="lazyOnload">{`
        try {
    ...
    function codeValidation() {
      ...
      `}</Script>
<Script id="ebook-script-1-8" strategy="lazyOnload">{`
        try {
      ...
      `}</Script>
<Script id="ebook-script-1-9" strategy="lazyOnload">{`
        try {
      ...
      `}</Script>
<Script id="ebook-script-1-10" strategy="lazyOnload">{`
        try {
    ...
    document.getElementById('sendCodeButton').addEventListener('click', function() {
      ...
      `}</Script>
<Script id="ebook-script-1-11" strategy="lazyOnload">{`
        try {
          document.getElementById('sendCodeButton').addEventListener('click', function() {
      ...
      `}</Script>
<Script id="ebook-script-1-12" strategy="lazyOnload">{`
        try {
    ...
    function displaySuccessAlert(message) {
      ...
      `}</Script>
<Script id="ebook-script-1-13" strategy="lazyOnload">{`
        try {
          document.getElementById('resend-button-2').addEventListener('click', function() {
    ...
    function startCountdown() {
      ...
      `}</Script>
<Script id="ebook-script-1-14" strategy="lazyOnload">{`
        try {
...
const togglePassword = document.querySelector('#togglePassword');
    ...
    togglePassword.addEventListener('click', function() {
      ...
      `}</Script>
<Script id="ebook-script-1-15" strategy="lazyOnload">{`
        try {
  ...
  gtag('config', 'G-Y8WSH8YVSZ');
      ...
      `}</Script>
<Script id="ebook-script-1-16" strategy="lazyOnload">{`
        try {
          function closeAlert() {
...
\$(document).ready(function() {
    ...
    \$('#subscribeForm').on('submit', function(event) {
      ...
      `}</Script>
<Script id="ebook-script-1-17" strategy="lazyOnload">{`
        try {
    ...
    window.dispatchEvent(new Event('scroll'));
      ...
      `}</Script>
<Script id="ebook-script-1-18" strategy="lazyOnload">{`
        try {
          document.addEventListener("DOMContentLoaded", function () {
        fetch('./components/footer.html')
            .then(response => response.text())
      ...
      `}</Script>
<Script id="ebook-script-1-19" strategy="lazyOnload">{`
        try {
          document.addEventListener('DOMContentLoaded', function () {
      ...
      `}</Script>
<Script id="ebook-script-1-20" strategy="lazyOnload">{`
        try {
          grecaptcha.ready(function() {
             grecaptcha.execute('6LelLRwqAAAAAL6aHLVU9nE96q6UI6_H11dUU_Ix', {
                 action: 'submit'
             }).then(function(token) {
         ...
         function validateForm() {
             ...
             var ebook_name = document.getElementById("ebook_name");
             var ebook_lname = document.getElementById("ebook_lname");
             var ebook_email = document.getElementById("ebook_email");
             var ebook_comname = document.getElementById("ebook_comname");
         ...
         \$(document).ready(function() {
            ...
            \$('#registrationForm').submit(function(event) {
                ...
                if (isValid) {
                    ...
                    \$.ajax({
                        type: 'POST',
                        url: 'head/engine/ajax/__ajax_ebook_form.php', // Replace with your server endpoint URL
                        data: formData,
                        success: function(response) {
                            console.log('AJAX success:', response);
                            // Handle success: Show the success div and hide the initial div
                            \$('#initialDiv').hide();
                            \$('#successDiv').show();
                            \$('#ebook_submit_btn').removeAttr('disabled');
                        },
                        error: function(xhr, status, error) {
                    ...
                    // Form validation failed, enable submit button
                    \$('#ebook_submit_btn').removeAttr('disabled');
                }
            });
            ...
            document.getElementById('ebook_email').addEventListener('input', function (e) {
                const email = e.target.value;
                const emailError = document.getElementById('ebook_email_error');
            ...
            const fields = ['ebook_name', 'ebook_lname', 'ebook_email', 'ebook_comname'];
            ...
            function validateForm() {
                ...
                fields.forEach(field => {
                    ...
                    // Additional validation logic (email, phone number length, etc.)
                    if (field === 'ebook_email') {
                        const emailRegex = /^[^\\s@]+@[^\\s@]+\\.[^\\s@]+\$/;
    ...
    <link rel="Touchmark" href="e-book-01.php%3Febook_content_id=2.html#" />
...
<div id="modelConfirm" className="fixed hidden z-50 inset-0 bg-black/70 overflow-y-auto h-full w-full px-4">
    <div className="flex justify-center items-center h-full">
        <div className="relative mx-auto shadow-xl bg-white max-w-[500px]">
            ...
            <div className="flex items-end justify-between p-2">
                <a href="e-book-01.php%3Febook_content_id=2.html#" id="goBack" className="flex justify-start items-center text-[#194F97] hover:underline text-sm hidden">
                    <svg id="fi_2985161" height="20" viewBox="0 0 128 128" width="20" xmlns="http://www.w3.org/2000/svg">
                        <path id="Left_Arrow_4_" d="m84 108c-1.023 0-2.047-.391-2.828-1.172l-40-40c-1.563-1.563-1.563-4.094 0-5.656l40-40c1.563-1.563 4.094-1.563 5.656 0s1.563 4.094 0 5.656l-37.172 37.172 37.172 37.172c1.563 1.563 1.563 4.094 0 5.656-.781.781-1.805 1.172-2.828 1.172z" fill="#194F97"></path>
                    </svg>
                    Go Back
    ...
    <link rel="Touchmark" href="e-book-01.php%3Febook_content_id=2.html#" />
          ...
          {/* Ebook 2 Scripts */}
          <Script id="ebook-script-2-0" strategy="lazyOnload">{`
        try {
          document.addEventListener('DOMContentLoaded', function() {
        const searchButton = document.getElementById('btn-search');
        const searchInput = document.getElementById('input-search');
      ...
      `}</Script>
<Script id="ebook-script-2-1" strategy="lazyOnload">{`
        try {
          // Function to open the modal and disable body scrolling
    window.openModal = function(modalId) {
        document.getElementById(modalId).style.display = 'block';
    ...
    document.getElementById('goBack').addEventListener('click', function(event) {
      ...
      `}</Script>
<Script id="ebook-script-2-2" strategy="lazyOnload">{`
        try {
          document.addEventListener("DOMContentLoaded", function() {
        fetch('./components/footer.html')
            .then(response => response.text())
      ...
      `}</Script>
<Script id="ebook-script-2-3" strategy="lazyOnload">{`
        try {
          document.getElementById('resend-button').addEventListener('click', function() {
        var messageContainer = document.getElementById('message-container');
        var countdownElement = document.getElementById('countdown');
      ...
      `}</Script>
<Script id="ebook-script-2-4" strategy="lazyOnload">{`
        try {
          document.getElementById('resend-button-2').addEventListener('click', function() {
        var messageContainer = document.getElementById('message-container-2');
        var countdownElement = document.getElementById('countdown-2');
      ...
      `}</Script>
<Script id="ebook-script-2-5" strategy="lazyOnload">{`
        try {
          document.getElementById('continueButton1').addEventListener('click', function(event) {
        var emailInput = document.getElementById('email');
        var warningMessage = document.getElementById('email-warning');
      ...
      `}</Script>
<Script id="ebook-script-2-6" strategy="lazyOnload">{`
        try {
          document.getElementById('submitButton').addEventListener('click', function(event) {
        var emailInput = document.getElementById('email-2');
        var warningMessage = document.querySelector('[x-text="validation.email.message"]');
      ...
      `}</Script>
<Script id="ebook-script-2-7" strategy="lazyOnload">{`
        try {
          function emailValidation() {
        return {
            email: '',
    ...
    function codeValidation() {
      ...
      `}</Script>
<Script id="ebook-script-2-8" strategy="lazyOnload">{`
        try {
          document.getElementById('subscribedForm').addEventListener('submit', function(event) {
        event.preventDefault(); // Prevent default form submission
      ...
      `}</Script>
<Script id="ebook-script-2-9" strategy="lazyOnload">{`
        try {
          document.getElementById('subscribedForm').addEventListener('submit', function(e) {
        e.preventDefault();
      ...
      `}</Script>
<Script id="ebook-script-2-10" strategy="lazyOnload">{`
        try {
          document.getElementById('loginForm').addEventListener('submit', function(e) {
        e.preventDefault(); // Prevent the default form submission
    ...
    document.getElementById('sendCodeButton').addEventListener('click', function() {
      ...
      `}</Script>
<Script id="ebook-script-2-11" strategy="lazyOnload">{`
        try {
          document.getElementById('sendCodeButton').addEventListener('click', function() {
        // Immediately switch forms for testing purposes
        document.getElementById('step3').classList.add('hidden');
      ...
      `}</Script>
<Script id="ebook-script-2-12" strategy="lazyOnload">{`
        try {
          document.getElementById('verifyCodeForm').addEventListener('submit', function(e) {
        e.preventDefault(); // Prevent the default form submission
    ...
    function displaySuccessAlert(message) {
      ...
      `}</Script>
<Script id="ebook-script-2-13" strategy="lazyOnload">{`
        try {
          document.getElementById('resend-button-2').addEventListener('click', function() {
        const email = document.getElementById('email-2').value; // Assuming email field ID in step 3 is 'email-2'
    ...
    function startCountdown() {
      ...
      `}</Script>
<Script id="ebook-script-2-14" strategy="lazyOnload">{`
        try {
          document.addEventListener('DOMContentLoaded', () => {
        // Assuming you have a way to check if the user is signed in
        // Example: check session storage or an API call to set the isSignedIn value
...
const togglePassword = document.querySelector('#togglePassword');
    ...
    togglePassword.addEventListener('click', function() {
      ...
      `}</Script>
<Script id="ebook-script-2-15" strategy="lazyOnload">{`
        try {
          window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  ...
  gtag('config', 'G-Y8WSH8YVSZ');
      ...
      `}</Script>
<Script id="ebook-script-2-16" strategy="lazyOnload">{`
        try {
          function closeAlert() {
    \$('#successAlert').addClass('hidden');
}
...
\$(document).ready(function() {
    ...
    \$('#subscribeForm').on('submit', function(event) {
      ...
      `}</Script>
<Script id="ebook-script-2-17" strategy="lazyOnload">{`
        try {
          window.addEventListener('scroll', function () {
        var header = document.querySelector('#navbar');
        var logo = document.querySelector('#logo');
    ...
    window.dispatchEvent(new Event('scroll'));
      ...
      `}</Script>
<Script id="ebook-script-2-18" strategy="lazyOnload">{`
        try {
          document.addEventListener("DOMContentLoaded", function () {
        fetch('./components/footer.html')
            .then(response => response.text())
      ...
      `}</Script>
<Script id="ebook-script-2-19" strategy="lazyOnload">{`
        try {
          document.addEventListener('DOMContentLoaded', function () {
      var animationContainer = document.getElementById('lottie-animation');
      ...
      `}</Script>
<Script id="ebook-script-2-20" strategy="lazyOnload">{`
        try {
          grecaptcha.ready(function() {
             grecaptcha.execute('6LelLRwqAAAAAL6aHLVU9nE96q6UI6_H11dUU_Ix', {
                 action: 'submit'
    ...
    <link rel="Touchmark" href="e-book-01.php%3Febook_content_id=3.html#" />
...
<div id="modelConfirm" className="fixed hidden z-50 inset-0 bg-black/70 overflow-y-auto h-full w-full px-4">
    <div className="flex justify-center items-center h-full">
        <div className="relative mx-auto shadow-xl bg-white max-w-[500px]">
            ...
            <div className="flex items-end justify-between p-2">
                <a href="e-book-01.php%3Febook_content_id=3.html#" id="goBack" className="flex justify-start items-center text-[#194F97] hover:underline text-sm hidden">
                    <svg id="fi_2985161" height="20" viewBox="0 0 128 128" width="20" xmlns="http://www.w3.org/2000/svg">
                        <path id="Left_Arrow_4_" d="m84 108c-1.023 0-2.047-.391-2.828-1.172l-40-40c-1.563-1.563-1.563-4.094 0-5.656l40-40c1.563-1.563 4.094-1.563 5.656 0s1.563 4.094 0 5.656l-37.172 37.172 37.172 37.172c1.563 1.563 1.563 4.094 0 5.656-.781.781-1.805 1.172-2.828 1.172z" fill="#194F97"></path>
                    </svg>
                    Go Back
    ...
    <link rel="Touchmark" href="e-book-01.php%3Febook_content_id=3.html#" />
          ...
          {/* Ebook 3 Scripts */}
          <Script id="ebook-script-3-0" strategy="lazyOnload">{`
        try {
          document.addEventListener('DOMContentLoaded', function() {
        const searchButton = document.getElementById('btn-search');
        const searchInput = document.getElementById('input-search');
      ...
      `}</Script>
<Script id="ebook-script-3-1" strategy="lazyOnload">{`
        try {
          // Function to open the modal and disable body scrolling
    window.openModal = function(modalId) {
        document.getElementById(modalId).style.display = 'block';
    ...
    document.getElementById('goBack').addEventListener('click', function(event) {
      ...
      `}</Script>
<Script id="ebook-script-3-2" strategy="lazyOnload">{`
        try {
          document.addEventListener("DOMContentLoaded", function() {
        fetch('./components/footer.html')
            .then(response => response.text())
      ...
      `}</Script>
<Script id="ebook-script-3-3" strategy="lazyOnload">{`
        try {
          document.getElementById('resend-button').addEventListener('click', function() {
        var messageContainer = document.getElementById('message-container');
        var countdownElement = document.getElementById('countdown');
      ...
      `}</Script>
<Script id="ebook-script-3-4" strategy="lazyOnload">{`
        try {
          document.getElementById('resend-button-2').addEventListener('click', function() {
        var messageContainer = document.getElementById('message-container-2');
        var countdownElement = document.getElementById('countdown-2');
      ...
      `}</Script>
<Script id="ebook-script-3-5" strategy="lazyOnload">{`
        try {
          document.getElementById('continueButton1').addEventListener('click', function(event) {
        var emailInput = document.getElementById('email');
        var warningMessage = document.getElementById('email-warning');
      ...
      `}</Script>
<Script id="ebook-script-3-6" strategy="lazyOnload">{`
        try {
          document.getElementById('submitButton').addEventListener('click', function(event) {
        var emailInput = document.getElementById('email-2');
        var warningMessage = document.querySelector('[x-text="validation.email.message"]');
      ...
      `}</Script>
<Script id="ebook-script-3-7" strategy="lazyOnload">{`
        try {
          function emailValidation() {
        return {
            email: '',
    ...
    function codeValidation() {
      ...
      `}</Script>
<Script id="ebook-script-3-8" strategy="lazyOnload">{`
        try {
          document.getElementById('subscribedForm').addEventListener('submit', function(event) {
        event.preventDefault(); // Prevent default form submission
      ...
      `}</Script>
<Script id="ebook-script-3-9" strategy="lazyOnload">{`
        try {
          document.getElementById('subscribedForm').addEventListener('submit', function(e) {
        e.preventDefault();
      ...
      `}</Script>
<Script id="ebook-script-3-10" strategy="lazyOnload">{`
        try {
          document.getElementById('loginForm').addEventListener('submit', function(e) {
        e.preventDefault(); // Prevent the default form submission
    ...
    document.getElementById('sendCodeButton').addEventListener('click', function() {
      ...
      `}</Script>
<Script id="ebook-script-3-11" strategy="lazyOnload">{`
        try {
          document.getElementById('sendCodeButton').addEventListener('click', function() {
        // Immediately switch forms for testing purposes
        document.getElementById('step3').classList.add('hidden');
      ...
      `}</Script>
<Script id="ebook-script-3-12" strategy="lazyOnload">{`
        try {
          document.getElementById('verifyCodeForm').addEventListener('submit', function(e) {
        e.preventDefault(); // Prevent the default form submission
    ...
    function displaySuccessAlert(message) {
      ...
      `}</Script>
<Script id="ebook-script-3-13" strategy="lazyOnload">{`
        try {
          document.getElementById('resend-button-2').addEventListener('click', function() {
        const email = document.getElementById('email-2').value; // Assuming email field ID in step 3 is 'email-2'
    ...
    function startCountdown() {
      ...
      `}</Script>
<Script id="ebook-script-3-14" strategy="lazyOnload">{`
        try {
          document.addEventListener('DOMContentLoaded', () => {
        // Assuming you have a way to check if the user is signed in
        // Example: check session storage or an API call to set the isSignedIn value
...
const togglePassword = document.querySelector('#togglePassword');
    ...
    togglePassword.addEventListener('click', function() {
      ...
      `}</Script>
<Script id="ebook-script-3-15" strategy="lazyOnload">{`
        try {
          window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  ...
  gtag('config', 'G-Y8WSH8YVSZ');
      ...
      `}</Script>
<Script id="ebook-script-3-16" strategy="lazyOnload">{`
        try {
          function closeAlert() {
    \$('#successAlert').addClass('hidden');
}
...
\$(document).ready(function() {
    ...
    \$('#subscribeForm').on('submit', function(event) {
      ...
      `}</Script>
<Script id="ebook-script-3-17" strategy="lazyOnload">{`
        try {
          window.addEventListener('scroll', function () {
        var header = document.querySelector('#navbar');
        var logo = document.querySelector('#logo');
    ...
    window.dispatchEvent(new Event('scroll'));
      ...
      `}</Script>
<Script id="ebook-script-3-18" strategy="lazyOnload">{`
        try {
          document.addEventListener("DOMContentLoaded", function () {
        fetch('./components/footer.html')
            .then(response => response.text())
      ...
      `}</Script>
<Script id="ebook-script-3-19" strategy="lazyOnload">{`
        try {
          document.addEventListener('DOMContentLoaded', function () {
      var animationContainer = document.getElementById('lottie-animation');
      ...
      `}</Script>
<Script id="ebook-script-3-20" strategy="lazyOnload">{`
        try {
          grecaptcha.ready(function() {
             grecaptcha.execute('6LelLRwqAAAAAL6aHLVU9nE96q6UI6_H11dUU_Ix', {
                 action: 'submit'
