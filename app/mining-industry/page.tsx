...
export default function Page() {
  return (
    ...
    <link rel="Touchmark" href="mining-industry.html#" />
    ...
    <link rel="icon" type="image/png" sizes="16x1 56" href="https://touchmarkwf.com/timesheet/front_assets/images/logo/logoT.png" />
    ...
    <div className="flex justify-center items-center h-full">
        <div className="relative mx-auto shadow-xl bg-white max-w-[500px]">
            ...
            <div className="flex items-end justify-between p-2">
                <a href="mining-industry.html#" id="goBack" className="flex justify-start items-center text-[#194F97] hover:underline text-sm hidden">
            ...
            <div id="step4" className="p-5 hidden">
                ...
                <section className="relative 2xl:h-[720px] lg:h-[620px] h-[400px] w-full flex items-center justify-center text-center bg-cover bg-center lg:mt-0 mt-10" style={{ "backgroundImage": "url('assets/front/home/min_banner_1721888115.PNG')" }}>
            <div className="xl:max-w-screen-2xl 2xl:max-w-screen-2xl lg:max-w-screen-lg px-4 md:px-6 lg:px-8 mx-auto py-10 lg:py-24">
                <div className="grid grid-cols-12 lg:gap-4">
                    <div className="lg:col-span-7 col-span-12 text-white text-left lg:pt-5">
                        <p className="text-xs lg:text-sm xl:text-sm 2xl:text-base mt-4 font-inter lg:block hidden">Home / Industries/ Mining                        </p>
                        <h1 className="mt-4 text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-gellix">
                        Efficient resource extraction and sustainable practices</h1>
                    </div>
            ...
            <div className="grid grid-cols-12 lg:gap-4">
                <div className="lg:col-span-9 col-span-12">
                    ...
                    <h2 className="mt-1.5 lg:mt-1.5 xl:mt-3 2xl:mt-5 2xl:text-5xl xl:text-4xl lg:text-4xl text-3xl font-gellix">
                        Optimize resource extraction and sustainability with our advanced mining technologies</h2>
                </div>
            ...
            <div className="grid grid-cols-12 mt-10">
                <div className="2xl:col-span-5 lg:col-span-5 col-span-12 flex justify-center items-center">
                    <img src="assets/front/home/min_overview_1721888590.PNG" className="" />
                </div>
...
<li style={{ "boxSizing": "border-box", "border": "0px solid #e5e7eb", "fontSize": "16px" }}>Security, natural compliance, and operational proficiency are the fundamental objectives of our computer program arrangements for the mining segment. All parts of mining operations, from asset extraction to metal handling, are directed by the comprehensive administration frameworks we construct. Utilizing these advances will offer assistance to minimize working costs and increment efficiency by checking hardware execution, planning generation, and allotting specialists in an effective manner.</li>
<li style={{ "boxSizing": "border-box", "border": "0px solid #e5e7eb", "marginTop": "calc(1.25rem * calc(1 - var(--tw-space-y-reverse)))", "marginBottom": "calc(1.25rem * var(--tw-space-y-reverse))", "fontSize": "16px" }}>In the mining industry, security is of the most extreme significance. To ensure that working environment security controls are satisfied, our innovation manages advanced observing and detailing frameworks. These contain faculty wellbeing checking frameworks, computerized caution frameworks for perilous circumstances, and real-time mining location observation. In expansion to guaranteeing adherence to industry rules and security prerequisites, our arrangements help decrease risks.</li>
<li style={{ "boxSizing": "border-box", "border": "0px solid #e5e7eb", "marginTop": "calc(1.25rem * calc(1 - var(--tw-space-y-reverse)))", "marginBottom": "calc(1.25rem * var(--tw-space-y-reverse))", "fontSize": "16px" }}>Our computer program has devices for natural compliance and observing since natural supportability is another vital issue in the mining industry. This incorporates checking the impacts of mining operations on the environment, arranging squander, and making a difference to reestablish mined locales. With the utilization of our items, businesses can appear on their back for maintainable homes whereas moreover complying with natural standards.</li>
</ul>                        </ul>
        ...
        <section className="2xl:max-w-screen-2xl xl:max-w-screen-[100rem] lg:max-w-screen-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8 pt-14 lg:pt-24 xl:pt-24 2xl:pt-32">
            <div className="grid grid-cols-12 lg:gap-4">
                <div className="lg:col-span-9 col-span-12">
                    <h3 className="text-xs lg:text-sm xl:text-sm 2xl:text-base text-[#194F97] font-medium">Enhance resource extraction and sustainability with our advanced mining technologies</h3>
                    <h2 className="mt-1.5 lg:mt-1.5 xl:mt-3 2xl:mt-5 2xl:text-5xl xl:text-4xl lg:text-4xl text-3xl font-gellix">
                        Our solutions improve safety with advanced monitoring and ensure environmental compliance</h2>
                </div>
                <div className="lg:col-span-3 lg:block hidden">
                </div>
            </div>
            ...
            <div className="owl-carousel owl-theme" id="is-p">
                        ...
                        <div className="group flex flex-col justify-between h-full">
                            ...
                            <div className="bg-[#D3ECFF] bg-opacity-30 pt-5 pl-5 text-black relative overflow-hidden group-hover:text-white group-hover:bg-[#194F97] h-full flex flex-col">
                                ...
                                <p className="text-transparent group-hover:text-white pr-5 text-[14px] lg:text-[12px] xl:text-[12px] 2xl:text-[14px] mt-[10px] lg:mt-[10px] xl:mt-[10px] 2xl:mt-[20px] font-inter font-regular flex-grow">
                                    Lower operating expenses and boost productivity by implementing all-encompassing management systems that track worker allocation, production scheduling, and equipment performance.                                </p>
                                <div className="flex justify-end items-end mt-auto">
                                    <div className="group mt-[12px] xl:mt-[0px] 2xl:mt-[20px] xl:h-36 2xl:h-auto">
                                        
                                        <div className="block group-hover:hidden">
                                            <img src="assets/front/home/min_service_1721888647.PNG" />
                                        </div>

                                        
                                        <div className="hidden group-hover:block">
                                            <img src="assets/front/home/min_service_hover_1721888647.PNG" />
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="group flex flex-col justify-between h-full">
                            ...
                            <div className="bg-[#D3ECFF] bg-opacity-30 pt-5 pl-5 text-black relative overflow-hidden group-hover:text-white group-hover:bg-[#194F97] h-full flex flex-col">
                                ...
                                <h1 className="pr-5 text-xl lg:text-lg xl:text-xl 2xl:text-2xl font-gellix">
                                    Safety Monitoring:</h1>
                                <p className="text-transparent group-hover:text-white pr-5 text-[14px] lg:text-[12px] xl:text-[12px] 2xl:text-[14px] mt-[10px] lg:mt-[10px] xl:mt-[10px] 2xl:mt-[20px] font-inter font-regular flex-grow">
                                    To help you comply with safety requirements and reduce risks, ensure workplace safety using cutting-edge monitoring and reporting systems, such as automated hazard alert systems, real-time mining area surveillance, and personnel health monitoring.                                </p>
                                <div className="flex justify-end items-end mt-auto">
                                    <div className="group mt-[12px] xl:mt-[0px] 2xl:mt-[20px] xl:h-36 2xl:h-auto">
                                        
                                        <div className="block group-hover:hidden">
                                            <img src="assets/front/home/min_service_1721888686.PNG" />
                                        </div>

                                        
                                        <div className="hidden group-hover:block">
                                            <img src="assets/front/home/min_service_hover_1721888686.PNG" />
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="group flex flex-col justify-between h-full">
                            ...
                            <div className="bg-[#D3ECFF] bg-opacity-30 pt-5 pl-5 text-black relative overflow-hidden group-hover:text-white group-hover:bg-[#194F97] h-full flex flex-col">
                                ...
                                <h1 className="pr-5 text-xl lg:text-lg xl:text-xl 2xl:text-2xl font-gellix">
                                    Environmental Compliance</h1>
                                <p className="text-transparent group-hover:text-white pr-5 text-[14px] lg:text-[12px] xl:text-[12px] 2xl:text-[14px] mt-[10px] lg:mt-[10px] xl:mt-[10px] 2xl:mt-[20px] font-inter font-regular flex-grow">
                                    To encourage environmental sustainability and regulatory compliance and to show a commitment to sustainable practices, keep an eye on environmental impacts, manage trash, and assist with site restoration projects.                                </p>
                                <div className="flex justify-end items-end mt-auto">
                                    <div className="group mt-[12px] xl:mt-[0px] 2xl:mt-[20px] xl:h-36 2xl:h-auto">
                                        
                                        <div className="block group-hover:hidden">
                                            <img src="assets/front/home/min_service_1721888708.PNG" />
                                        </div>

                                        
                                        <div className="hidden group-hover:block">
                                            <img src="assets/front/home/min_service_hover_1721888708.PNG" />
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="group flex flex-col justify-between h-full">
                            ...
                            <div className="bg-[#D3ECFF] bg-opacity-30 pt-5 pl-5 text-black relative overflow-hidden group-hover:text-white group-hover:bg-[#194F97] h-full flex flex-col">
                                ...
                                <h1 className="pr-5 text-xl lg:text-lg xl:text-xl 2xl:text-2xl font-gellix">
                                    Data analytics</h1>
                                <p className="text-transparent group-hover:text-white pr-5 text-[14px] lg:text-[12px] xl:text-[12px] 2xl:text-[14px] mt-[10px] lg:mt-[10px] xl:mt-[10px] 2xl:mt-[20px] font-inter font-regular flex-grow">
                                    Make the most of resource exploration and extraction procedures by utilizing geospatial data and predictive analytics to reduce environmental impact and maximize mining operations&amp;#039; worth.                                </p>
                                <div className="flex justify-end items-end mt-auto">
                                    <div className="group mt-[12px] xl:mt-[0px] 2xl:mt-[20px] xl:h-36 2xl:h-auto">
                                        
                                        <div className="block group-hover:hidden">
                                            <img src="assets/front/home/min_service_1721888733.PNG" />
                                        </div>

                                        
                                        <div className="hidden group-hover:block">
                                            <img src="assets/front/home/dan-w-txt.png" />
                                        </div>
                                    </div>
                                </div>
