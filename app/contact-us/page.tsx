...
export default function Page() {
  return (
    ...
    <link rel="Touchmark" href="contact-us.html#" />
    ...
    <div className="flex justify-center items-center h-full">
        <div className="relative mx-auto shadow-xl bg-white max-w-[500px]">
            ...
            <div className="flex items-end justify-between p-2">
                <a href="contact-us.html#" id="goBack" className="flex justify-start items-center text-[#194F97] hover:underline text-sm hidden">
        ...
        <div className="w-full flex h-screen">
            <div className="grid grid-cols-12 w-full md:pr-6 lg:pr-8 lg:gap-0 gap-4">
                <div className="lg:col-span-5 col-span-12 bg-cover lg:order-1 order-3" style={{ "backgroundImage": "url('src/assets/img/contact-us/contact-us-left-bg.png')" }}>
                    <div className="2xl:mt-40 xl:mt-32 lg:mt-32 mt-5 lg:pb-0 pb-7">
                        ...
                        <div className="mt-10 px-7">
                            ...
                            <div className="flex justify-start items-center space-x-2 mt-5">
                                <a href="https://in.linkedin.com/company/touchmarkdes"><img src="src/assets/img/home/icons/linkedin-icon.svg" className="h-10" /></a>
                                <a href="https://www.instagram.com/touchmarkdes/"><img src="src/assets/img/home/icons/instagram-icon.svg" className="h-10" /></a>
                                <a href="https://www.facebook.com/touchmarkdes/"><img src="src/assets/img/home/icons/fb-icon.svg" className="h-10" /></a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <form id="contactForm" method="post" noValidate={true}>
                                ...
                                <div className="mt-6 lg:mt-6 xl:mt-11 2xl:mt-11 space-y-4 text-left">
                                    <div className="grid grid-cols-6 gap-4">
                                        ...
                                        <div className="lg:col-span-3 col-span-6 space-y-2 mt-2.5">
                                            <h3 className="font-inter font-medium">Phone Number<span className="required-star">*</span></h3>
                                            <div className="flex items-center border border-[#194F97]">
                                                <button id="dropdown-phone-button" data-dropdown-toggle="dropdown-phone" className="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-black hover:bg-gray-200" type="button">
                                                    IND +91
                                                ...
                                                <div className="relative w-full">
                                                    <input type="text" id="contact_number" name="contact_number" className="border-none block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 focus:ring-blue-500" placeholder="0000000000" maxLength={10} autoComplete="off" required={true} />
                                                </div>
                                            </div>
...
const togglePassword = document.querySelector('#togglePassword');
  ...
  gtag('config', 'G-Y8WSH8YVSZ');
      ...
      <Script id="page-script-17" strategy="lazyOnload">{`
        ...
        function onTabClick(event) {
            ...
            tabs.forEach(tab => {
                ...
                tab.classList.add("text-white/40", "border-transparent");
            });
            ...
            event.target.classList.remove("text-white/40", "border-transparent");
    ...
    \$(document).ready(function() {
        ...
        \$('#contactForm').submit(function(event) {
            ...
            if (isValid) {
                ...
                \$.ajax({
                    type: 'POST',
                    url: 'head/engine/ajax/__ajax_contact_form.php', // Replace with your server endpoint URL
                    data: formData,
                    success: function(response) {
        ...
        // Input mask for phone number (limit to 10 digits)
        ...
        const fields = ['first_name', 'last_name', 'email', 'contact_number', 'company_name', 'location', 'project_type'];
        ...
        function validateForm() {
            ...
            // Specific validation for contact_number (e.g., phone number format)
            const contactNumberInput = document.getElementById('contact_number');
            const contactNumberError = document.getElementById('contact_number_error');

            if (contactNumberInput.value.trim()) {
                const phoneNumber = contactNumberInput.value.replace(/\\D/g, ''); // Remove non-digit characters
                if (phoneNumber.length !== 10) {
                    contactNumberInput.classList.add('error');
                    contactNumberError.textContent = \`Please enter a valid 10-digit phone number.\`;
                    formValid = false;
                } else {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        var dropdownButton = document.getElementById('dropdown-phone-button');
        var dropdownMenu = document.getElementById('dropdown-phone');
        ...
        var countryButtons = dropdownMenu.querySelectorAll('button[role="menuitem"]');
        countryButtons.forEach(function(button) {
            button.addEventListener('click', function() {
                var selectedText = button.innerText.trim();
