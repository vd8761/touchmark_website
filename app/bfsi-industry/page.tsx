...
export default function Page() {
  return (
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="https://touchmarkwf.com/timesheet/front_assets/images/logo/logoT.png" />
                ...
                <section className="relative 2xl:h-[720px] lg:h-[620px] h-[400px] w-full flex items-center justify-center text-center bg-cover bg-center lg:mt-0 mt-10" style={{ "backgroundImage": "url('assets/front/home/bfsi_banner_1721883113.webp')" }}>
            <div className="xl:max-w-screen-2xl 2xl:max-w-screen-2xl lg:max-w-screen-lg px-4 md:px-6 lg:px-8 mx-auto py-10 lg:py-24">
                <div className="grid grid-cols-12 lg:gap-4">
                    <div className="lg:col-span-7 col-span-12 text-white text-left lg:pt-5">
                        <p className="text-xs lg:text-sm xl:text-sm 2xl:text-base mt-4 font-inter lg:block hidden">Home / Industries / BFSI                        </p>
                        <h1 className="mt-4 text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-gellix">
                        Enhancing financial services with innovation and efficiency</h1>
                    </div>
            ...
            <div className="grid grid-cols-12 lg:gap-4">
                <div className="lg:col-span-9 col-span-12">
                    ...
                    <h2 className="mt-1.5 lg:mt-1.5 xl:mt-3 2xl:mt-5 2xl:text-5xl xl:text-4xl lg:text-4xl text-3xl font-gellix">
                        To provide BFSI with comprehensive experiences into buyer behavior, we utilize AI and Enormous Information analytics</h2>
                </div>
            ...
            <div className="grid grid-cols-12 mt-10">
                <div className="2xl:col-span-5 lg:col-span-5 col-span-12 flex justify-center items-center">
                    <img decoding="async" src="assets/front/home/bfsi_overview_1721883182.webp" className="" />
                </div>
...
<li style={{ "boxSizing": "border-box", "border": "0px solid #e5e7eb" }}>This permits us to optimize resource administration, offer personalized managing account encounters, and successfully oversee hazards. The resources of the organization and its clients are shielded by these advances, which are too fundamental in distinguishing and combating fraud.</li>
<li style={{ "boxSizing": "border-box", "marginTop": "calc(1.25rem * calc(1 - var(--tw-space-y-reverse)))", "marginBottom": "calc(1.25rem * var(--tw-space-y-reverse))", "border": "0px solid #e5e7eb" }}>By giving clients speedy, simple, and secure versatile applications to oversee accounts, execute exchanges, and communicate with money related benefit suppliers, our portable managing account arrangements change client encounters. Progressed capabilities like discourse acknowledgment, biometric distinguishing proof, and AI-powered chatbots for client benefit are included in these solutions.</li>
<li style={{ "boxSizing": "border-box", "marginTop": "calc(1.25rem * calc(1 - var(--tw-space-y-reverse)))", "marginBottom": "calc(1.25rem * var(--tw-space-y-reverse))", "border": "0px solid #e5e7eb" }}>Another crucial component of our BFSI items is administrative compliance. With the offer assistance of our RegTech arrangements, which computerize compliance methods, our clients can effortlessly comply with changing rules without compromising operational viability. This incorporates keeping up compliance printed material, robotizing detailing methods, and making beyond any doubt the framework is continuously prepared for audits.</li>
</ul>                        </ul>
        ...
        <section className="2xl:max-w-screen-2xl xl:max-w-screen-[100rem] lg:max-w-screen-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8 pt-14 lg:pt-24 xl:pt-24 2xl:pt-32">
            <div className="grid grid-cols-12 lg:gap-4">
                <div className="lg:col-span-9 col-span-12">
                    <h3 className="text-xs lg:text-sm xl:text-sm 2xl:text-base text-[#194F97] font-medium">Banking, Financial Services and Insurance</h3>
                    <h2 className="mt-1.5 lg:mt-1.5 xl:mt-3 2xl:mt-5 2xl:text-5xl xl:text-4xl lg:text-4xl text-3xl font-gellix">
                        Harness our technology, consulting expertise to drive innovation and achieve your business goals with tailored solutions</h2>
                </div>
                <div className="lg:col-span-3 lg:block hidden">
                </div>
            </div>
            ...
            <div className="owl-carousel owl-theme" id="is-p">
                        ...
                        <div className="group flex flex-col justify-between h-full">
                            ...
                            <div className="bg-[#D3ECFF] bg-opacity-30 pt-5 pl-5 text-black relative overflow-hidden group-hover:text-white group-hover:bg-[#194F97] h-full flex flex-col">
                                ...
                                <p className="text-transparent group-hover:text-white pr-5 text-[14px] lg:text-[12px] xl:text-[12px] 2xl:text-[14px] mt-[10px] lg:mt-[10px] xl:mt-[10px] 2xl:mt-[20px] font-inter font-regular flex-grow">
                                    Our cutting-edge BFSI solutions, which include safe trading platforms, central banking systems, and extensive insurance administration systems, improve customer assistance and streamline back-office operations.                                </p>
                                <div className="flex justify-end items-end mt-auto">
                                    <div className="group mt-[12px] xl:mt-[0px] 2xl:mt-[20px] xl:h-36 2xl:h-auto">
                                        
                                        <div className="block group-hover:hidden">
                                            <img decoding="async" loading="lazy" src="assets/front/home/bfsi_service_1721883345.webp" />
                                        </div>

                                        
                                        <div className="hidden group-hover:block">
                                            <img decoding="async" loading="lazy" src="assets/front/home/bfsi_service_hover_1721883345.webp" />
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="group flex flex-col justify-between h-full">
                            ...
                            <div className="bg-[#D3ECFF] bg-opacity-30 pt-5 pl-5 text-black relative overflow-hidden group-hover:text-white group-hover:bg-[#194F97] h-full flex flex-col">
                                ...
                                <h1 className="pr-5 text-xl lg:text-lg xl:text-xl 2xl:text-2xl font-gellix">
                                    AI Analytics</h1>
                                <p className="text-transparent group-hover:text-white pr-5 text-[14px] lg:text-[12px] xl:text-[12px] 2xl:text-[14px] mt-[10px] lg:mt-[10px] xl:mt-[10px] 2xl:mt-[20px] font-inter font-regular flex-grow">
                                    We offer insights into customer behavior by utilizing AI and Big Data. This allows for tailored banking experiences, efficient asset management, and successful risk management, all of which improve fraud detection and prevention.                                </p>
                                <div className="flex justify-end items-end mt-auto">
                                    <div className="group mt-[12px] xl:mt-[0px] 2xl:mt-[20px] xl:h-36 2xl:h-auto">
                                        
                                        <div className="block group-hover:hidden">
                                            <img decoding="async" loading="lazy" src="assets/front/home/bfsi_service_1721883407.webp" />
                                        </div>

                                        
                                        <div className="hidden group-hover:block">
                                            <img decoding="async" loading="lazy" src="assets/front/home/bfsi_service_hover_1721883407.webp" />
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="group flex flex-col justify-between h-full">
                            ...
                            <div className="bg-[#D3ECFF] bg-opacity-30 pt-5 pl-5 text-black relative overflow-hidden group-hover:text-white group-hover:bg-[#194F97] h-full flex flex-col">
                                ...
                                <h1 className="pr-5 text-xl lg:text-lg xl:text-xl 2xl:text-2xl font-gellix">
                                    Mobile Banking</h1>
                                <p className="text-transparent group-hover:text-white pr-5 text-[14px] lg:text-[12px] xl:text-[12px] 2xl:text-[14px] mt-[10px] lg:mt-[10px] xl:mt-[10px] 2xl:mt-[20px] font-inter font-regular flex-grow">
                                    With features like voice recognition, biometric identification, and AI-powered chatbots, our mobile banking applications provide quick, safe, and easy account management, transaction execution, and customer care engagement.                                </p>
                                <div className="flex justify-end items-end mt-auto">
                                    <div className="group mt-[12px] xl:mt-[0px] 2xl:mt-[20px] xl:h-36 2xl:h-auto">
                                        
                                        <div className="block group-hover:hidden">
                                            <img decoding="async" loading="lazy" src="assets/front/home/bfsi_service_1721883436.webp" />
                                        </div>

                                        
                                        <div className="hidden group-hover:block">
                                            <img decoding="async" loading="lazy" src="assets/front/home/bfsi_service_hover_1721883436.webp" />
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="group flex flex-col justify-between h-full">
                            ...
                            <div className="bg-[#D3ECFF] bg-opacity-30 pt-5 pl-5 text-black relative overflow-hidden group-hover:text-white group-hover:bg-[#194F97] h-full flex flex-col">
                                ...
                                <p className="text-transparent group-hover:text-white pr-5 text-[14px] lg:text-[12px] xl:text-[12px] 2xl:text-[14px] mt-[10px] lg:mt-[10px] xl:mt-[10px] 2xl:mt-[20px] font-inter font-regular flex-grow">
                                    By automating activities such as automated reporting, compliance paperwork, and audit preparation, our RegTech solutions ensure conformity to changing requirements without sacrificing operational efficiency.                                </p>
                                <div className="flex justify-end items-end mt-auto">
                                    <div className="group mt-[12px] xl:mt-[0px] 2xl:mt-[20px] xl:h-36 2xl:h-auto">
                                        
                                        <div className="block group-hover:hidden">
                                            <img decoding="async" loading="lazy" src="assets/front/home/bfsi_service_1721883459.webp" />
                                        </div>

                                        
                                        <div className="hidden group-hover:block">
                                            <img decoding="async" loading="lazy" src="assets/front/home/bfsi_service_hover_1721883459.webp" />
                                        </div>
                                    </div>
                                </div>
    ...
    <div className="grid grid-cols-12 gap-4 mt-10">
                        ...
                        <img decoding="async" loading="lazy" src="assets/front/home/Blog%201.webp" className="transition-transform group-hover:scale-125 duration-500 lg:w-auto w-full" alt="Responsive image" />
                        ...
                        <img decoding="async" loading="lazy" src="assets/front/home/Blog%202.webp" className="transition-transform group-hover:scale-125 duration-500 lg:w-auto w-full" alt="Responsive image" />
                        <div className="absolute inset-0 flex justify-end items-end">
                            <div className="bg-gradient-to-t from-black/45 to-transparent p-5 transition-opacity duration-300 group-hover:from-black/90 group-hover:to-black/0 w-full">
                                <div className="flex justify-between items-end">
                                    <div>
                        ...
                        <img decoding="async" loading="lazy" src="assets/front/home/blog%203.webp" className="transition-transform group-hover:scale-125 duration-500 lg:w-auto w-full" alt="Responsive image" />
                        <div className="absolute inset-0 flex justify-end items-end">
                            <div className="bg-gradient-to-t from-black/45 to-transparent p-5 transition-opacity duration-300 group-hover:from-black/90 group-hover:to-black/0 w-full">
                                <div className="flex justify-between items-end">
                                    <div>
                        ...
                        <img decoding="async" loading="lazy" src="assets/front/home/blog%204.webp" className="transition-transform group-hover:scale-125 duration-500 lg:w-auto w-full" alt="Responsive image" />
                        <div className="absolute inset-0 flex justify-end items-end">
                            <div className="bg-gradient-to-t from-black/45 to-transparent p-5 transition-opacity duration-300 group-hover:from-black/90 group-hover:to-black/0 w-full">
                                <div className="flex justify-between items-end">
                                    <div>
