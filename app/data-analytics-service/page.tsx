...
export default function Page() {
  return (
    ...
    <link rel="Touchmark" href="da-service.html#" />
    ...
    <div className="flex justify-center items-center h-full">
        <div className="relative mx-auto shadow-xl bg-white max-w-[500px]">
            ...
            <div className="flex items-end justify-between p-2">
                <a href="da-service.html#" id="goBack" className="flex justify-start items-center text-[#194F97] hover:underline text-sm hidden">
...
<a className="lg:hidden block relative overflow-hidden border border-[#194F97] px-3 py-2 inline-flex justify-center items-center group mt-7" href="da-service.html#"> <span className="relative z-10 text-[#194F97] group-hover:text-white transition-colors text-sm uppercase"> View all</span> </a></div>        </section>
...
\$(document).ready(function() {
    ...
    function fetchTabContent(tabId) {
        ...
        fetch('head/engine/ajax/__ajax_da_fetch_tab_content.php', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded'
            },
