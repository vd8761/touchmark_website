...
export default function Page() {
  return (
    ...
    <div className="overflow-x-hidden lg:overflow-x-auto">
        ...
        <section className="2xl:max-w-screen-2xl xl:max-w-screen-[100rem] lg:max-w-screen-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8 py-14 lg:py-24 xl:py-24 2xl:py-32 text-black bg-white">
            <div className="grid grid-cols-12">
            ...
            <div className="grid grid-cols-12 gap-4 lg:gap-4 xl:gap-4 2xl:gap-4 mt-10">
                ...
                <div className="lg:col-span-6 col-span-12 relative overflow-hidden group">
                    <a href="/blog/articles/a-360-view-of-business-process-management-system" target="_blank">
                        ...
                        </a><div className="absolute inset-0 flex justify-end items-end"><a href="/blog/articles/a-360-view-of-business-process-management-system" target="_blank">
                            </a><div className="bg-gradient-to-t from-black/45 to-transparent p-5 transition-opacity duration-300 group-hover:from-black/90 group-hover:to-black/0 w-full"><a href="/blog/articles/a-360-view-of-business-process-management-system" target="_blank">
                                </a><div className="flex justify-between items-end"><a href="/blog/articles/a-360-view-of-business-process-management-system" target="_blank">

                                    <div>
                                        
                                        <h1 className="text-white font-gellix text-lg lg:text-xl xl:text-xl 2xl:text-2xl pt-2">
                                            A 360* View Of Business Process Management System
                                        </h1>
                                    </div>
                ...
                <div className="lg:col-span-6 col-span-12 grid grid-rows-2 lg:gap-4 gap-4">

                    <div className="lg:row-span-1 row-span-2 grid grid-cols-2 lg:gap-4 gap-4 ">
                        ...
                        <div className="lg:col-span-1 col-span-2 relative overflow-hidden group">
                            <a href="https://touchmarkdes.com/blog/articles/blog/articles/key-factors-why-business-process-management-systems-are-successful" target="_blank">
                                ...
                                </a><div className="absolute inset-0 flex justify-end items-end"><a href="https://touchmarkdes.com/blog/articles/blog/articles/key-factors-why-business-process-management-systems-are-successful" target="_blank">
                                    </a><div className="bg-gradient-to-t from-black/45 to-transparent p-5 transition-opacity duration-300 group-hover:from-black/90 group-hover:to-black/0 w-full"><a href="https://touchmarkdes.com/blog/articles/blog/articles/key-factors-why-business-process-management-systems-are-successful" target="_blank">
                                        </a><div className="flex justify-between items-end"><a href="https://touchmarkdes.com/blog/articles/blog/articles/key-factors-why-business-process-management-systems-are-successful" target="_blank">
                                            <div>
                        ...
                        <div className="lg:col-span-1 col-span-2 relative overflow-hidden group">
                            <a href="/blog/articles/increasing-your-productivity-using-business-process-management-system" target="_blank">
                                ...
                                </a><div className="absolute inset-0 flex justify-end items-end"><a href="/blog/articles/increasing-your-productivity-using-business-process-management-system" target="_blank">
                                    </a><div className="bg-gradient-to-t from-black/45 to-transparent p-5 transition-opacity duration-300 group-hover:from-black/90 group-hover:to-black/0 w-full"><a href="/blog/articles/increasing-your-productivity-using-business-process-management-system" target="_blank">
                                        </a><div className="flex justify-between items-end"><a href="/blog/articles/increasing-your-productivity-using-business-process-management-system" target="_blank">
                                            <div>
                    ...
                    <div className="lg:block hidden lg:row-span-1 row-span-2 relative overflow-hidden group">
                        <a href="/blog/articles/real-time-iot-applications-in-the-retail-industry" target="_blank">
                            ...
                            </a><div className="absolute inset-0 flex justify-end items-end"><a href="/blog/articles/real-time-iot-applications-in-the-retail-industry" target="_blank">
                                </a><div className="w-full bg-gradient-to-t from-black/45 to-transparent p-5 transition-opacity duration-300 group-hover:from-black/90 group-hover:to-black/0"><a href="/blog/articles/real-time-iot-applications-in-the-retail-industry" target="_blank">
                                    </a><div className="flex justify-between items-end"><a href="/blog/articles/real-time-iot-applications-in-the-retail-industry" target="_blank">
                                        <div>
                    ...
                    <div className="lg:hidden block row-span-1 grid grid-cols-2 lg:gap-4">
                        <div className="lg:col-span-1 col-span-2 relative overflow-hidden group">
                            <a href="/blog/articles/why-internet-of-things" target="_blank">
                                ...
                                </a><div className="absolute inset-0 flex justify-end items-end"><a href="/blog/articles/why-internet-of-things" target="_blank">
                                    </a><div className="bg-gradient-to-t from-black/45 to-transparent p-5 transition-opacity duration-300 group-hover:from-black/90 group-hover:to-black/0 w-full"><a href="/blog/articles/why-internet-of-things" target="_blank">
                                        </a><div className="flex justify-between items-end"><a href="/blog/articles/why-internet-of-things" target="_blank">
                                            <div>
                ...
                <div className="lg:block hidden lg:col-span-3 col-span-12 relative overflow-hidden group">
                    <a href="/blog/articles/how-does-iot-benefit-the-supply-chain" target="_blank">
                        ...
                        </a><div className="absolute inset-0 flex justify-end items-end"><a href="/blog/articles/how-does-iot-benefit-the-supply-chain" target="_blank">
                            </a><div className="bg-gradient-to-t from-black/45 to-transparent p-5 transition-opacity duration-300 group-hover:from-black/90 group-hover:to-black/0 w-full"><a href="/blog/articles/how-does-iot-benefit-the-supply-chain" target="_blank">
                                </a><div className="flex justify-center items-end"><a href="/blog/articles/how-does-iot-benefit-the-supply-chain" target="_blank">
                                    <div>
                ...
                <div className="lg:block hidden lg:col-span-3 col-span-12 relative overflow-hidden group">
                    <a href="/blog/articles/key-benefits-in-hiring-a-dedicated-software-development-team" target="_blank">
                        ...
                        </a><div className="absolute inset-0 flex justify-end items-end"><a href="/blog/articles/key-benefits-in-hiring-a-dedicated-software-development-team" target="_blank">
                            </a><div className="bg-gradient-to-t from-black/45 to-transparent p-5 transition-opacity duration-300 group-hover:from-black/90 group-hover:to-black/0 w-full"><a href="/blog/articles/key-benefits-in-hiring-a-dedicated-software-development-team" target="_blank">
                                </a><div className="flex justify-center items-end"><a href="/blog/articles/key-benefits-in-hiring-a-dedicated-software-development-team" target="_blank">
                                    <div>
                ...
                <div className="lg:block hidden lg:col-span-3 col-span-12 relative overflow-hidden group">
                    <a href="/blog/articles/the-value-of-big-data-analysis-in-the-retail-industry" target="_blank">
                        ...
                        </a><div className="absolute inset-0 flex justify-end items-end"><a href="/blog/articles/the-value-of-big-data-analysis-in-the-retail-industry" target="_blank">
                            </a><div className="bg-gradient-to-t from-black/45 to-transparent p-5 transition-opacity duration-300 group-hover:from-black/90 group-hover:to-black/0 w-full"><a href="/blog/articles/the-value-of-big-data-analysis-in-the-retail-industry" target="_blank">
                                </a><div className="flex justify-center items-end"><a href="/blog/articles/the-value-of-big-data-analysis-in-the-retail-industry" target="_blank">
                                    <div>
