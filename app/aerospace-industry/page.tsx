    ...
    <link rel="icon" type="image/png" sizes="16x16" href="https://touchmarkwf.com/timesheet/front_assets/images/logo/logoT.png" />
                ...
                <div className="grid grid-cols-12 mt-10">
                    <div className="2xl:col-span-5 lg:col-span-5 col-span-12 flex justify-center items-center">
                        <img decoding="async" src="assets/front/home/ad_overview_1721881470.webp" className="" />
                    </div>
                                    ...
                                    <div className="flex justify-end items-end mt-auto">
                                        <div className="group mt-[12px] xl:mt-[0px] 2xl:mt-[20px] xl:h-36 2xl:h-auto">
                                            ...
                                            <div className="block group-hover:hidden">
                                                <img decoding="async" loading="lazy" src="assets/front/home/ad_service_1721882595.webp" />
                                            </div>

                                            
                                            <div className="hidden group-hover:block">
                                                <img decoding="async" loading="lazy" src="assets/front/home/ad_service_hov_1721882595.webp" />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="bg-[#D3ECFF] bg-opacity-30 pt-5 pl-5 text-black relative overflow-hidden group-hover:text-white group-hover:bg-[#194F97] h-full flex flex-col">
                                    ...
                                    <div className="flex justify-end items-end mt-auto">
                                        <div className="group mt-[12px] xl:mt-[0px] 2xl:mt-[20px] xl:h-36 2xl:h-auto">
                                            ...
                                            <div className="block group-hover:hidden">
                                                <img decoding="async" loading="lazy" src="assets/front/home/ad_service_1721882638.webp" />
                                            </div>

                                            
                                            <div className="hidden group-hover:block">
                                                <img decoding="async" loading="lazy" src="assets/front/home/ad_service_hov_1721882638.webp" />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="bg-[#D3ECFF] bg-opacity-30 pt-5 pl-5 text-black relative overflow-hidden group-hover:text-white group-hover:bg-[#194F97] h-full flex flex-col">
                                    ...
                                    <div className="flex justify-end items-end mt-auto">
                                        <div className="group mt-[12px] xl:mt-[0px] 2xl:mt-[20px] xl:h-36 2xl:h-auto">
                                            ...
                                            <div className="block group-hover:hidden">
                                                <img decoding="async" loading="lazy" src="assets/front/home/ad_service_1721882668.webp" />
                                            </div>

                                            
                                            <div className="hidden group-hover:block">
                                                <img decoding="async" loading="lazy" src="assets/front/home/ad_service_hov_1721882668.webp" />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="bg-[#D3ECFF] bg-opacity-30 pt-5 pl-5 text-black relative overflow-hidden group-hover:text-white group-hover:bg-[#194F97] h-full flex flex-col">
                                    ...
                                    <div className="flex justify-end items-end mt-auto">
                                        <div className="group mt-[12px] xl:mt-[0px] 2xl:mt-[20px] xl:h-36 2xl:h-auto">
                                            ...
                                            <div className="block group-hover:hidden">
                                                <img decoding="async" loading="lazy" src="assets/front/home/ad_service_1721882700.webp" />
                                            </div>

                                            
                                            <div className="hidden group-hover:block">
                                                <img decoding="async" loading="lazy" src="assets/front/home/ad_service_hov_1721882700.webp" />
                                            </div>
                                        </div>
                                    </div>
