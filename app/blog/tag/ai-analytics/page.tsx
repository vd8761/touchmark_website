        ...
        <section className="2xl:max-w-screen-2xl xl:max-w-screen-[100rem] lg:max-w-screen-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8 pt-7 lg:pt-12 xl:pt-12 2xl:pt-16">
            <div className="block lg:flex justify-between items-end">
                <div className="lg:space-y-6">
                    <div className="flex justify-start items-center space-x-2">
                        <a href="https://in.linkedin.com/company/touchmarkdes" target="_blank" rel="noopener noreferrer" aria-label="Touchmark on LinkedIn" className="group">
                            <img decoding="async" src="../../images/home/icons/linkedin-black-fill.svg" className="h-8 group-hover:hidden" />
                            <img decoding="async" loading="lazy" src="../../images/home/icons/linkedin-blue-fill.svg" className="h-8 hidden group-hover:block" />
                        </a>
                        <a href="https://www.facebook.com/touchmarkdes/" target="_blank" rel="noopener noreferrer" aria-label="Touchmark on Facebook" className="group">
                            <img decoding="async" loading="lazy" src="../../images/home/icons/facebook-black-fill.svg" className="h-8 group-hover:hidden" />
                            <img decoding="async" loading="lazy" src="../../images/home/icons/facebook-blue-fill.svg" className="h-8 hidden group-hover:block" />
                        </a>
                        <a href="https://www.instagram.com/touchmarkdes/" target="_blank" rel="noopener noreferrer" aria-label="Touchmark on Instagram" className="group">
                            <img decoding="async" loading="lazy" src="../../images/home/icons/insta-black-fill.svg" className="h-8 group-hover:hidden" />
                            <img decoding="async" loading="lazy" src="../../images/home/icons/insta-blue-fill.svg" className="h-8 hidden group-hover:block" />
                        </a>
                        <a href="https://x.com/touchmarkdes" target="_blank" rel="noopener noreferrer" aria-label="Touchmark on X" className="group">
                            <img decoding="async" loading="lazy" src="../../images/home/icons/twitter-black-fill.svg" className="h-8 group-hover:hidden" />
                            <img decoding="async" loading="lazy" src="../../images/home/icons/twitter-blue-fill.svg" className="h-8 hidden group-hover:block" />
                        </a>
                    </div>
            ...
            <div className="grid grid-cols-12 gap-8 pt-3 lg:pt-6 xl:pt-6 2xl:pt-8">
                    ...
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="/assets/front/home/Blog 1.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="/assets/front/home/Blog 2.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="/assets/front/home/blog 3.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="/assets/front/home/blog 4.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/blog%205.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics | Digital</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/blog%206.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/blog%207.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/blog%208.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/blog%209.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/blog%2010.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/Agile%20blog1.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/Blog%20Website%20image%2001-10-24%20(1).png" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        <a href="/blog/articles/scalable-software-solutions-how-to-make-your-technology-grow-with-your-business">
                            <h1 className="font-gellix text-lg lg:text-xl xl:text-xl 2xl:text-2xl hover:underline hover:text-[#194f97]">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/Blog%20Website%20image%2008-10-24%20(1).png" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        <a href="/blog/articles/how-do-software-solutions-help-the-legal-industry">
                            <h1 className="font-gellix text-lg lg:text-xl xl:text-xl 2xl:text-2xl hover:underline hover:text-[#194f97]">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/blog_1728975904.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/blog_1729587230.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/blog_1730181954.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/website%20image%20%20Maximizing%20Global%20Expansion%20%20Digital.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/website%20image%20%20Maximizing%20Global%20Expansion%20%20Digital%20(1)%20(1).jpg" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        <a href="/blog/articles/strategic-it-consulting-for-small-and-medium-businesses">
                            <h1 className="font-gellix text-lg lg:text-xl xl:text-xl 2xl:text-2xl hover:underline hover:text-[#194f97]">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/website%20image%20Unlocking%20CRM%20Success%20and%20Transforming%20Customer%20Engagement%20final.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/website%20image%20The%20Role%20of%20Software%20in%20Transforming%20the%20Tourism%20Management%20Industry%20(1).jpg" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        <a href="/blog/articles/the-role-of-software-in-transforming-the-tourism-management-industry">
                            <h1 className="font-gellix text-lg lg:text-xl xl:text-xl 2xl:text-2xl hover:underline hover:text-[#194f97]">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/1%20Blog%20image%20Leveraging%20Data%20for%20Decision%20Making%20(1).jpg" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        <a href="/blog/articles/leveraging-data-for-decision-making-high-impact-in-cost-savings">
                            <h1 className="font-gellix text-lg lg:text-xl xl:text-xl 2xl:text-2xl hover:underline hover:text-[#194f97]">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/blog_1733819064.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/Improving%20Education%20website%20image%20(1).jpg" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        <a href="/blog/articles/improving-education-industry-with-software-solutions">
                            <h1 className="font-gellix text-lg lg:text-xl xl:text-xl 2xl:text-2xl hover:underline hover:text-[#194f97]">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/Blog%20Website%20image.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/Website%20image%20How%20Touchmark%20Inspires.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
...
Imagine in such a workplace where all the ideas no matter how unconventional, are cultivated &amp; appreciated. This is the atmosphere we work to build. Employee creativity is key to our growth as well as enabling challenges to become opportunities.</span></p>
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/Website%20image%20Vision%20to%20reality.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/website%20image%20Building%20a%20Culture.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/How%20Custom%20Software%20Enhances%20E-Commerce%20%20website%20image.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/website%20image%20DevOps%20%20Cloud%20Migration%202.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/website%20image%20How%20AI%20and%20ML%20are%20Making%20Cloud%20Migration%20Easier%20for%20Enterprises%202.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/website%20image%20How%20Enterprise%20Software%20Drives%20Efficiency%20real%20estate.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/Feb_25.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/march%2004.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/March%2011%20(1).jpg" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        <a href="/blog/articles/from-risk-management-in-project-to-maximizing-success">
                            <h1 className="font-gellix text-lg lg:text-xl xl:text-xl 2xl:text-2xl hover:underline hover:text-[#194f97]">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/March%2018.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        <a href="/blog/articles/adapting-qa-to-agile-while-ensuring-software-quality">
                            <h1 className="font-gellix text-lg lg:text-xl xl:text-xl 2xl:text-2xl hover:underline hover:text-[#194f97]">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/March%2025.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/blog_1744362411.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/website%20imageThe%20Role%20of%20AI%20in%20Cybersecurity.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/website%20image%20Quantum%20Computing%20is%20Coming.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/How%20IoT%20Is%20%20Paving%20the%20Way%20%20for%20a%20Greener,%20More%20%20Efficient%20Urban%20Future.jpg" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        <a href="/blog/articles/how-iot-is-paving-the-way-for-a-greener-more-efficient-urban-future">
                            <h1 className="font-gellix text-lg lg:text-xl xl:text-xl 2xl:text-2xl hover:underline hover:text-[#194f97]">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/website%20image%20Blockchain%20without%20cyrpto.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/Website%20ImageWhy%20Cloud-Native%20is%20a%20Game%20Changer.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/Website%20AI.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/website%20imageThe%20Rise%20of%20Generative%20AI%20that%20%20What%20It%20Means%20for%20Content,%20Marketing,%20and%20Business%20%20(1).jpg" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        <a href="/blog/articles/how-generative-ai-is-transforming-content-marketing-and-business">
                            <h1 className="font-gellix text-lg lg:text-xl xl:text-xl 2xl:text-2xl hover:underline hover:text-[#194f97]">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/website%20How%20AI%20Agents%20Will%20Change%20the%20Way%20We%20Work%20in%20the%20Next%203%20Years.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="https://touchmarkdes.com/assets/front/home/Website image What Every Business Needs to Know About Digital Twins—Before It’s Too Late.jpg" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
                        <a href="/blog/articles/what-every-business-needs-to-know-about-digital-twins-before-its-too-late">
                            <h1 className="font-gellix text-lg lg:text-xl xl:text-xl 2xl:text-2xl hover:underline hover:text-[#194f97]">
                        ...
                        <a href="/blog/tag/ai-analytics" className="inline-flex">
                            <h6 className="font-inter text-sm hover:text-[#194f97] hover:underline">AI &amp; Analytics</h6>
                                ...
                                <div className="lg:col-span-4 col-span-12 group hover:shadow-xl bg-white border">
                    <div className="relative overflow-hidden">
                        <img decoding="async" loading="lazy" src="../../assets/front/home/blog_1751378001.webp" className="transition-transform group-hover:scale-105 duration-300" />
                    </div>
                    <div className="p-5 space-y-5">
