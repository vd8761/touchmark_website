...
export default function Page() {
  return (
    ...
    <link rel="Touchmark" href="privacy-policy.php.html#" />
...
<div id="modelConfirm" className="fixed hidden z-50 inset-0 bg-black/70 overflow-y-auto h-full w-full px-4">
    <div className="flex justify-center items-center h-full">
        <div className="relative mx-auto shadow-xl bg-white max-w-[500px]">
            ...
            <div className="flex items-end justify-between p-2">
                <a href="privacy-policy.php.html#" id="goBack" className="flex justify-start items-center text-[#194F97] hover:underline text-sm hidden">
    ...
    <div className="containered">
        <h1 className="heading-term">Privacy Policy</h1>
        <p className="para-term">Personal information you provide to Touchmark Descience Pvt Ltd through the Service is governed by Touchmark Descience Pvt Ltd Privacy Policy. Your election to use the Service indicates your acceptance of the terms of the Touchmark Descience Pvt Ltd Privacy Policy.</p>
        <p className="para-term">You are responsible for maintaining confidentiality of your username, password and other sensitive information. You are responsible for all activities that occur in your user account and you agree to inform us immediately of any unauthorized use of your user account by email to info@touchmarkdes.com. We are not responsible for any loss or damage to you or to any third party incurred as a result of any unauthorized access and/or use of your user account, or otherwise.</p>
        ...
        <h2 className="heading-terms">Inactive User Accounts Policy</h2>
